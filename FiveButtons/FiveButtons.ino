...
byte digitalPins[] = {6, 7, 8, 9, 10}; //You can of select other digital pins, if you like
...
void loop() {
  ...
  switch(i)
  {
    ...
    case 3: ledStateOut=true;   break;
    case 4: ledStateOut=false;  break;
    case 5: ledStateOut=true;   break;
  }   
  digitalWrite(ledPin, ledStateOut);
}
